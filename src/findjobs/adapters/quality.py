...
ADAPTER_QUALITY_GATES: dict[str, AdapterQualityGate] = {
    ...
    "topsec_official": AdapterQualityGate(
        adapter="topsec_official",
        fixture="topsec.json",
        offline_tests=("TestTopSecOfficialAdapter",),
        official_source=True,
        salary_facts_only=True,
        target_relevance_filtering=True,
        algorithm_exclusion=True,
        stable_identity=True,
        field_normalization=True,
        pagination="complete blank BeiSen scan with Count/short-page stop",
        deduplication="JobAdId, fallback title+location",
        detail_enrichment="BeiSen listing exposes complete Duty and Require fields",
        live_smoke="2026-07-13 verified 12 official postings; 1 target, 1 review",
    ),
    "stepfun_moka": AdapterQualityGate(
        adapter="stepfun_moka",
        fixture="stepfun.json",
        offline_tests=("TestStepFunMokaAdapter",),
        official_source=True,
        salary_facts_only=True,
        target_relevance_filtering=True,
        algorithm_exclusion=True,
        stable_identity=True,
        field_normalization=True,
        pagination="complete blank campus Moka scan with total/short-page stop",
        deduplication="id/jobId, fallback title+location",
        detail_enrichment="Moka jobDescription headings normalize to responsibilities/requirements",
        live_smoke="2026-07-13 verified 19 official postings; 3 target, 1 review",
        limitations=("campus-recruitment source only",),
    ),
