...
当前配置 **31 个来源**，其中 **30 个启用**（`is_active: true`）。
...
**具身智能**
智元机器人 AgiBot · 众擎机器人 EngineAI

具身智能公司沿用相同的岗位边界：仅保留 AI 工程、平台、部署和安全相关岗位；标题或岗位类型含“算法”的岗位一律排除，包括运动控制、感知、规划、强化学习和安全算法岗位。
